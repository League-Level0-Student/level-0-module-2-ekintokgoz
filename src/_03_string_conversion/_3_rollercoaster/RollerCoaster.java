...
public class RollerCoaster {
	...
	public static void main(String[] args) {
		...
		String heightToRide = JOptionPane.showInputDialog("Please enter your height in inches to go on the ride.");
		// Uncomment the line below...
		int heightAsInt = Integer.parseInt(heightToRide);
		if(heightAsInt <42) { 
			JOptionPane.showMessageDialog(null, "You must be a least 42 inches tall to ride the roller coaster pal! Grow some more.");
		} else if(heightAsInt>=48) {
			JOptionPane.showMessageDialog(null, "Hurray you can go on the ride!! Have fun!");
		} else {
